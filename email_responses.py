...
def send_email(name, receiver_email, slack_name, buddy_name, buddy_slack_name, buddy_objectives, buddy_personal_descr, buddy_email):
    ...
    # message["Subject"] = "WWCode #buddymeup Announcement: You Are Matched!"
    ...
    html += f"""
        ...
        Happy connecting! <br>
        <br>
        Isabella Hoesch and Nikita Parmar <br>
        WomenWhoCode Python <br>
        [Join our slack community <a href='https://join.slack.com/t/wwcodepython/shared_invite/zt-kp9jr2ht-zGyDmQD7YxICdVvlpfhGBw'>here</a>!]
    """
...
csv_filename = "/Users/nikitaparmar/Documents/WWCode/wwc_buddyprogram/datafiles/pairing_2/agape-lina.csv"
